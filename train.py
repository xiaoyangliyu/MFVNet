...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='models/detect/gelan-t-MFVNet.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'dataset/PlantDoc_aug1/data.yaml', help='dataset.yaml path')
