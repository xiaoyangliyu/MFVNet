...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'dataset/Tomato Leaf Disease.v63i.yolov9/data.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/VBPN_TOMOTODSE/weights/best.pt', help='model path(s)')
